...
public class UiCodeGenerator
{
	...
	public UiCodeGenerator(List<RuleDetail> rules, List<YoloObjectEntry> objs) {
		this.rules = rules;
...
//		print();
		...
		*/
		...
		IBuilder screenBuilder = new ScreenBuilder(_makeRule(), new ArrayList<>(baseList));
		 ...
		 * 스크립트 코드 생성
		 */
		IBuilder scriptBuilder = new ScriptBuilder();
	...
	public static void main(String [] args) {
		try {
			...
			UiCodeGenerator uiGen = new UiCodeGenerator(null, payload.getUiObjects());
